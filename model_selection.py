'''This file contains code for selecting model with appropriate range value.'''
...
model_dir = 'trained_models/2. model_selection'
...
r = int(input('Enter range value (1/2/3/4)'))
assert r == 1 or r == 2 or r == 3 or r == 4, "Incorrect range value entered. Try again."
batch_size = 16
...
for epoch in range(epochs):
    ...
    if (epoch+1)% save_steps == 0:
        torch.save(model.state_dict(), f'{model_dir}/strongly_entangling_layers_{dataset_str}_{config_list[0]}hw_range{r}_8q.pth')
